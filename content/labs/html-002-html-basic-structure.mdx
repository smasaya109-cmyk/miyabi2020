---
title: "2. HTMLの基本構造（doctype / html / head / body）"
date: "2026-01-26"
...
<HtmlCssDemo
  title="例1：headで読み込んだCSSが効いてるか確認する枠"
...
<HtmlCssDemo
  title="例2：headの情報（title）とbodyの見出しをセットで整える"
  html={String.raw`<header class="hero">
...
<HtmlCssDemo
  title="例3：bodyの中身を“セクション”として区切る"
  html={String.raw`<section class="section">
  <h2 class="section__title">本文エリア</h2>
  <p>ここにコンテンツを増やしていきます。</p>
</section>`}
  css={String.raw`.section {
  padding: 16px;
  border: 1px solid currentColor;
  border-radius: 18px;
