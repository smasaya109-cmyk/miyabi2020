---
title: "5. p / br / hr（段落・改行・区切りの使い分け）"
date: "2026-01-26"
...
<HtmlCssDemo
  title="例1：段落の余白を自然に（br不要）"
  html={String.raw`<article class="text">
  <h1>読みやすい文章</h1>
...
<HtmlCssDemo
  title="例3：住所ブロックを読みやすく（brの正しい使い所）"
  html={String.raw`<address class="addr">
  株式会社サンプル<br />
  東京都○○区○○ 1-2-3<br />
  受付：平日 10:00-18:00
</address>`}
